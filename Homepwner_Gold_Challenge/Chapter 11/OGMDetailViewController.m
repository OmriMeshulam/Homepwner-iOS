...
- (IBAction)takePicture:(id)sender {
    ...
    if ([UIImagePickerController
        ...
        // **** Begin Overlay code
        // overlay on top of camera lens view (camera source only)
        UIImageView *cameraOverlayView = [[UIImageView alloc]
                                          initWithImage:[UIImage imageNamed:@"crosshairs.png"]];
    ...
    imagePicker.allowsEditing = YES; // Allows a user to edit pics/vids
...
- (IBAction)deletePicture:(id)sender {
    [[OGMImageStore sharedStore] deleteImageForKey:self.item.itemKey];
